...
export type UseLatestMetricChangeQueryState = {
  ...
  data?: FetchLatestChangeQuery["mqlQuery"] | null;
...
export const initialState: UseLatestMetricChangeQueryState = {
  retries: 0,
  queryId: null,
...
export type Action =
  ...
  | { type: "postQueryCachedResultsSuccess";
      data: CreateLatestMetricChangeMutation;
  ...
  switch (action.type) {
    ...
    case "postQueryCachedResultsSuccess": {
      return {
        ...
        data: action.data?.queryLatestMetricChange?.query,
        fetchStartTime: null,
        isTakingForever: false,
        errorMessage: undefined,
      }
...
export default latestChangeReducer;
