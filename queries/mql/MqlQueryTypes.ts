...
export type FetchDimensionNamesQuery = { __typename?: "Query" } & Pick<
  Query,
  "dimensionNamesForMetrics"
>;
...
export type FetchDimensionValuesQuery = { __typename?: "Query" } & {
  metricByName?: Maybe<
    { __typename?: "Metric" } & Pick<Metric, "dimensionValues">
  >;
};
...
export type FetchMqlQueryLogQuery = { __typename?: "Query" } & {
  mqlQuery?: Maybe<
...
export type FetchMqlQueryLogsQuery = { __typename?: "Query" } & {
  queries?: Maybe<
    Array<
      Maybe<
        { __typename?: "MqlQuery" } & Pick<
          MqlQuery,
          "id" | "status" | "completedAt" | "startedAt" | "metrics"
        >
      >
    >
  >;
...
export type FetchMqlTimeSeriesQuery = { __typename?: "Query" } & {
  mqlQuery?: Maybe<
    { __typename?: "MqlQuery" } & Pick<
      MqlQuery,
      "id" | "status" | "metrics" | "dimensions"
    > & {
        result?: Maybe<
          Array<
            { __typename?: "MqlQueryResultSeries" } & Pick<
              MqlQueryResultSeries,
              "seriesValue"
            > & {
                data?: Maybe<
                  Array<
                    { __typename?: "TimeSeriesDatum" } & Pick<
                      TimeSeriesDatum,
                      "xDate" | "y"
                    >
                  >
...
export type MqlServerHealthCheckQueryVariables = Exact<{
  [key: string]: never;
}>;

export type MqlServerHealthCheckQuery = { __typename?: "Query" } & {
  healthReport?: Maybe<
    Array<
      Maybe<
        { __typename?: "MqlServerHealthItem" } & Pick<
          MqlServerHealthItem,
