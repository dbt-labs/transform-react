...
export type MqlQuerySuccessRatesQueryVariables = Exact<{ [key: string]: never; }>;


export type MqlQuerySuccessRatesQuery = (
  { __typename?: 'Query' }
  & Pick<Query, 'oneHourSuccessRate' | 'oneDaySuccessRate' | 'oneWeekSuccessRate'>
);
